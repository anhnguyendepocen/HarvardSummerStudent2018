...
auc(actuals, oneTreePreds)
auc(actuals, rfFitPreds)
auc(actuals, cvGLMpreds)
...
# Increase cutoff threshold because rather be cautious 
...
#more concise but transposed: confusionMatrix(actuals, cvGLMprobs[,2], cutoff = 0.8)

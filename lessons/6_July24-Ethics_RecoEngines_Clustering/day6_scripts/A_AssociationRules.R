...
# Discretize into binary outcome; discretize function has a bug!!
...
ctrl <- list(supp= 200/4000, # how many times *minimum* should the rule appear 
             conf = 0.5, # for a specific antecedent, at least 50% of the time the specific consequent must be found
...
# Examine; keep in mind that rules can be duplicated, LHS item sequence really doesn't matter
head(booksApr, 10)

# Top row
# 65  {ChildBks,CookBks,GeogBks} => {YouthBks} 0.06325  0.5776256 2.424452   253
# 65th rule: 
# Antecedent: If someone buys children's, cook and geography books, 
